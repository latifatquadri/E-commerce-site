  ...
  return (
    <div className="border-b-2 w-[90%] mx-auto py-8">
      <div className="flex justify-between w-[90%] mx-auto pt-8 pb-4 lg:pt-14 lg:pb-8">
        <h2 className="text-lg font-medium lg:font-bold lg:text-3xl ">
          Landmark Bridge Image
        </h2>
        <button className="p-2 w-32 text-sm bg-gray-800 hover:bg-black text-white lg:text-lg lg:w-44 ">
          ADD TO CART
        </button>
      </div>
      <div className="w-[90%] mx-auto relative py-4 justify-items-center">
        ...
        />
        <p className="bg-white text-black absolute p-2 left-0 bottom-0 mx-auto font-medium h-10 lg:h-20 lg:p-4 lg:font-bold">
          Photo of the day
        </p>
      </div>

      <div className="flex justify-between w-[90%] mx-auto gap-4">
        <p className="text-black text-sm font-normal lg:text-xl lg:font-semibold">
          About the Landmark Bridge Image
        </p>
        <p className="text-black text-sm font-normal lg:text-xl lg:font-semibold">
          People also buy
        </p>
